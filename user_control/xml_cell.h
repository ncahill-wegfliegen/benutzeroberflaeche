...
tinyxml2::XMLElement* make_element( tinyxml2::XMLDocument& doc, const nhill::ctrl::Cell& cell, std::string element_name );

template<> NHILL_USERCTRL_PORT_FUNCTION
tinyxml2::XMLError from_handle( nhill::ctrl::Cell& cell, tinyxml2::XMLHandle handle );
