...
// ab_oil_pressure_test_doc.h : interface of the CABOilPressTestDoc class
//
...
#include "../../../datenzugriff/ab_oil_pressure_test/ab_oil_pressure_test/test_container.h"
#include <memory>
...
protected:
   ...
   afx_msg void OnUpdateWellListOpen( CCmdUI* pCmdUI );
	afx_msg void OnPropertyOpen();
	afx_msg void OnUpdatePropertyOpen( CCmdUI* pCmdUI );
